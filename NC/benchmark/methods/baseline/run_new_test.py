import sys
sys.path.append('../../')
sys.path.append("/root/autodl-tmp/HGB_autobenchmark/root/autodl-tmp/HGB_autobenchmark/NC/benchmark/scripts")
...
def run_model_DBLP(args):
    ...
    for _ in range(args.repeat):
        ...
        # training loop
        net.train()
        early_stopping = EarlyStopping(patience=args.patience, verbose=True, save_path='/root/autodl-tmp/HGB_autobenchmark/NC/benchmark/methods/baseline/checkpoint1/checkpoint_{}_{}.pt'.format(args.dataset, args.num_layers))
        
        # testing with evaluate_results_nc
        net.load_state_dict(torch.load('/root/autodl-tmp/HGB_autobenchmark/NC/benchmark/methods/baseline/checkpoint1/checkpoint_{}_{}_zhanshi.pt'.format(args.dataset, args.num_layers)))
        net.eval()
        test_logits = []
        with torch.no_grad():
