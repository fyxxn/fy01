import sys
sys.path.append('../../')
sys.path.append("/home/zlj/code/HGB/NC/benchmark/scripts")
...
def run_model_DBLP(args):
    ...
    for _ in range(args.repeat):
        ...
        net = myGAT1(g, args.edge_feats, len(dl.links['count'])+1, in_dims, args.hidden_dim, num_classes, args.num_layers, heads, F.elu, args.dropout, args.dropout, args.slope, True, 0.05)
        net.to(device)
...
if __name__ == '__main__':
    ...
    ap.add_argument('--edge-feats', type=int, default=64*2)
